...
| --- | --- | --- |
| `Perigon.templates` | `1.3.14` | Template package covered by this page |
...
The documentation line `10.0` identifies the .NET/Perigon CLI major line; `1.3.14` identifies the `Perigon.templates` package release. Update this matrix and both quick-start guides when the template package changes.
