...
- `ManagerBase<TDbContext, TEntity>(AppDbFactory dbContextFactory, IUserContext userContext, ILogger logger)`: Specifies database context and entity. The code generator uses this by default.
