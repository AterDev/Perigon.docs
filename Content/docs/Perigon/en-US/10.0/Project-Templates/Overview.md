...
We define the infrastructure needed by the application through code. You can read [Configuring Development Environment with Aspire](./Configuring-Dev-Environment-with-Aspire.md) to learn how to use it.
